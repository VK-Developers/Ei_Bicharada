            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-full lg:w-2/12 px-4">
                <div className="relative w-full mb-3">
                  ...
                  <div className="border-0 px-3 py-3 placeholder-gray-300 bg-white rounded text-sm shadow flex items-center focus:outline-none focus:ring w-full lg:w-11/12  justify-center ease-linear transition-all duration-150">
